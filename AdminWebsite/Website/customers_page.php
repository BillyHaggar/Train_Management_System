...
<div class="d-flex" id="wrapper">
  ...
  <div id="page-content-wrapper">
    ...
    <table id="header-search" style="margin-left: 60%; width: 500px;">
      <thead>
        <th><button id="openModal" class="btn button-on-white">Add Customer</button></th>
        <form method="post" action="PHP-Actions/Edit/edit_customer_page.php">
          <th>
            <input type="number" min=1 name="edit_customer" class="form-control" placeholder="ID">
            <br>
            <button type="submit" class="btn my-2 my-sm-0 button-on-white">Edit Customer</button>
          </th>
        </form>
        <form method="post" action="PHP-Actions/delete/delete_customer.php">
          <th>
            <input type="number" min=1 name="delete_id" class="form-control" placeholder="ID">
            <br>
            <button type="submit" class="btn my-2 my-sm-0 button-on-white">Delete Customer</button>
          </form>
        </th>
    </thead>
    </table>

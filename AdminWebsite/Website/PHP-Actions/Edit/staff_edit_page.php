...
<head>
  ...
  $target = $_POST['edit_staff'];
  $_SESSION['edit_staff_id'] = $target;
...
<div class="d-flex" id="wrapper">
  ...
  <div id="page-content-wrapper">
    ...
    <div class="container-fluid">
      <h1>Edit Staff: <?php echo $target; ?></h1><br>
      <div class="form-group">
        <form method="post" action="PHP-actions/Edit/edit_function/edit_staff.php">
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleFormControlTextarea1 last-name-form" name="role" value="<?php echo $user_rank; ?>">
          </div>
          <div class"form-group">
      ...
      <input type="hidden" id="infoPass" name="og_first_name" value="<?php echo $first_name; ?>">
      <input type="hidden" id="infoPass" name="og_last_name" value="<?php echo $last_name; ?>">
      <input type="hidden" id="infoPass" name="og_user_rank" value="<?php echo $user_rank; ?>">
      ...
      <input type="hidden" id="infoPass" name="og_contact_number" value="<?php echo $contact_number; ?>">
